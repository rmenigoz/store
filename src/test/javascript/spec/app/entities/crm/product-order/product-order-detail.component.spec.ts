...
import { ProductOrderDetailComponent } from 'app/entities/crm/product-order/product-order-detail.component';
import { ProductOrder } from 'app/shared/model/crm/product-order.model';
